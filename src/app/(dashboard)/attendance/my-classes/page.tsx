    ...
    <ProtectedRoute allowedRoles={['Teacher', 'Admin']}>
      <div className="space-y-6">
        <div>
            ...
            <p className="text-muted-foreground">Take attendance for your assigned classes. You can only mark attendance for classes you are assigned as Class Teacher.</p>
        </div>
