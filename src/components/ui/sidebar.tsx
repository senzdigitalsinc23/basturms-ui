    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            {children}
            <SidebarTrigger className={cn("absolute top-3 z-50", state === 'expanded' ? "right-3" : "left-1/2 -translate-x-1/2")} onClick={toggleSidebar}/>
          </div>
        </div>
      </div>
    )
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-7 w-7 rounded-full bg-card text-card-foreground hover:bg-muted", className)}
      {...props}
    >
...
>(({ className, children, ...props }, ref) => (
  <AccordionTrigger
    ...
    className={cn(
      ...
      "group-data-[collapsible=icon]:h-10 group-data-[collapsible=icon]:w-10 group-data-[collapsible=icon]:p-0 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:[&>span]:hidden",
