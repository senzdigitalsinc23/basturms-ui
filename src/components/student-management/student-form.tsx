...
export function StudentForm({ isEditMode = false, defaultValues, onSubmit }: StudentFormProps) {
    ...
    const methods = useForm<FormData>({
        ...
        defaultValues: isEditMode && defaultValues ? {
            ...
            enrollment_date: parseISO(defaultValues.admissionDetails.enrollment_date),
            class_assigned: defaultValues.admissionDetails.class_assigned,
            admission_status: defaultValues.admissionDetails.admission_status,
        } : {
            country: "Ghana",
            first_name: '',
            last_name: '',
                            ...
                            <TabsContent value="6">
                                <div className="space-y-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        ...
                                        <PreviewItem label="Class Assigned" value={classes.find(c => c.class_id === watch('class_assigned'))?.name} />
                        ...
                        <div className="flex justify-between mt-8">
                            ...
                            {currentStep === MAX_STEPS && (
                                <Button type="submit" disabled={isLoading} size="sm">
                                    ...
                                    {isEditMode ? 'Save Changes' : 'Submit Enrollment'}
                                </Button>
                            )}
                        </div>
                    </form>
